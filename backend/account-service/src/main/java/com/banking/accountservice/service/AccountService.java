...
//       convert Account to AccountResponse
    ...
    public void deductBalance(String accountNumber,BigDecimal amount){
        ...
        if(account.getBalance().compareTo(amount)<0){
            throw new RuntimeException("Insufficent funds for account"+accountNumber);
        }
...
//    Generate unique 12digit account number like: 000000000012
//    if the number is already present then it will continue the loop and generate new one
