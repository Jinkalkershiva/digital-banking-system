...
public class FraudDetectionService {
    ...
    private boolean isAmountSuspicious(String acccountNumber, BigDecimal amount) {
        String avgKey = "fraud:avg_amount" + acccountNumber;
    ...
    private boolean isBalanceCheckFailed(BigDecimal senderBalance ,BigDecimal amount){
        ...
        log.info("Balance check - amount: {} maxAllowed: {} suspicious: {} "+
                amount,maxAllowed,amount,amount.compareTo(maxAllowed)>0);
